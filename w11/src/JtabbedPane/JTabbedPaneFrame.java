...
import ballWorld.BallWorldPanel;
import ballWorld.BouncingBallSimple;
import painter.PainterPanel;
import slider.OvalPanel;
import slider.SliderDemo;
...
//      tabbedPane.addTab( "Tab Two", null, panel2, "Second Panel" ); 
		...
		SliderPanel ovalpainter = new SliderPanel();
		tabbedPane.addTab("SliderDemo", null, ovalpainter, "Second Panel");
...
//		panel3.add(label3, BorderLayout.CENTER);
		BallWorldPanel ballworldPanel = new BallWorldPanel();
		tabbedPane.addTab("BallWorld", null, ballworldPanel, "Third Panel");
